            ...
            <div className="flex flex-col items-center gap-12">
              ...
              <div className="text-center" style={{maxWidth: '720px'}}>
                ...
                <p className="text-gray-300" style={{lineHeight: '1.8'}}>
                  Today, the Mindsheep Labs team combines hands-on marketing specialists with AI engineers who build the custom tools that give our clients an edge. We&apos;re not a 200-person agency. We&apos;re a tight crew that moves fast, builds smart, and treats your ad spend like it&apos;s our own.
                </p>
              </div>
            </div>
          </div>
